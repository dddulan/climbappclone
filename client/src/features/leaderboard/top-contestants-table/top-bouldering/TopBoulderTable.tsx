...
import { LeaderboardContestantBoulder } from "./TopBoulderColumn";
import React, { useState, useEffect } from "react";
import { DataTable } from "@/components/ui/table";
import { getAllContestants } from "@/services/contestantService";


export const TopBoulderTable: React.FC = () => {
  ...
  { id: 10, name: "Jack Nguyen", school_id: 10, competition_id: 1, gender: "Male" },
    ...
    return (
        <div className="container mx-auto w-90">
            <DataTable columns={LeaderboardContestantBoulder} data={temp} />
        </div>
    );
}
