  ...
  return (
    <div className={classes.header}>
      ...
      <div className={classes.headerLinks}>
        ...
        <Link
          style={{color: currentTab ==  "competitions" ? "white" : "", background: currentTab == "competitions" ? "grey" : "" }}
        ...
        <Link
          style={{color: currentTab ==  "contestants" ? "white" : "", background: currentTab == "contestants" ? "grey" : "" }}
          className={classes.currentHeader}
        ...
        <Link
          style={{color: currentTab ==  "leaderboard" ? "white" : "", background: currentTab == "leaderboard" ? "grey" : "" }}
          className={classes.currentHeader}
